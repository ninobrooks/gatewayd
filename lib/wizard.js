...
Wizard.prototype._fundHotWallet = function (configProperties, callback){
  ...
  api.fundHotWallet(60, 'XRP', configProperties.cold_wallet_secret, function(err, payment){
    if(err){
      callback(err, null);
    } else {
...
Wizard.prototype._getKey = function(callback){
  var self = this;
